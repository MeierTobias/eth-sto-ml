...
\begin{itemize}
    ...
    \item Complexity: Deeper NNs can learn more complex data, perform better and may overfit less. % TODO: given the same number of parameters as a single-layer NN?
...
\end{equation*}
\newpar{}
% Sorry, will make a clean tabular here
\begin{center}
    \includegraphics[width=0.9\linewidth]{NN_cost_properties.png}
\end{center}
