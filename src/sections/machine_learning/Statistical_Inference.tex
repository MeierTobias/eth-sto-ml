...
\subsubsection{MAP}
The \textit{maximum a priori} estimator $\theta^*_{MAP}$ is similar to the MLE but with a added prior guess of an underlying distribution of $\theta$, according to \textit{bayes law}:
\noindent\begin{align*}
