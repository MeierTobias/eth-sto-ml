...
\begin{itemize}
    ...
    \item \item $\mu_X, \sigma_X$ give information about the marginal distribution of $X$
\end{itemize}
...
\begin{tabularx}{\linewidth}{@{}p{0.45\linewidth}p{0.55\linewidth}@{}}
    ...
    \end{minipage}
     &
    \includegraphics[width=0.9\linewidth, align=t]{Cont_Exponential_Distribution.png}
    \\
\end{tabularx}
...
\ptitle{Remarks:}
\begin{itemize}
    \item Simplest model for waitingor life times
