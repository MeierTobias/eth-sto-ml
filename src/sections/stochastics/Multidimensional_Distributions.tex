...
\begin{center}
    \includegraphics[width=0.6\linewidth]{python/pdf_plots/multi_dist.pdf}
\end{center}
...
\begin{center}
    \includegraphics[width=0.6\linewidth]{python/pdf_plots/multi_dist_marg.pdf}
\end{center}
\ptitle{Remarks}
\begin{itemize}
...
\begin{center}
    \includegraphics[width=0.6\linewidth]{python/pdf_plots/multi_dist_cond.pdf}
\end{center}
