...
\begin{center}
    \includegraphics[width=0.7\linewidth]{python/pdf_plots/multi_dist.pdf}
\end{center}
...
\begin{center}
    \includegraphics[width=0.7\linewidth]{python/pdf_plots/multi_dist_marg.pdf}
\end{center}
...
\begin{itemize}
    ...
    % TBD: is this right? (I guess it is) \item The conditional densities can either be derived fully analytical or one can directly plug in a value for the given x.
\end{itemize}
...
\begin{center}
    \includegraphics[width=0.7\linewidth]{python/pdf_plots/multi_dist_cond.pdf}
\end{center}
...
% TBD: I guess one could also have a function of Y instead of solely Y i.e.\ \mathbb{E}[g(Y)\mid X=x]
\noindent\begin{flalign*}
...
% TBD: everything except (some of) the remarks are already in the stochastics part (for discrete rnd. variables but formulas are identical). I would remove everything from here except the remarks as they reference to the marginals.
...
\begin{center}
    \includegraphics[width=0.8\linewidth]{2d_normal_dist.png}
\end{center}
