...
% TODO: everything except (some of) the remarks are already in the stochastics part (for discrete rnd. variables but formulas are identical). I would remove everything from here except the remarks as they reference to the marginals.
