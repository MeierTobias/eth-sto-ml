...
\ptitle{Exponentional Transformation}
...
\renewcommand{\arraystretch}{1.3}
\setlength{\oldtabcolsep}{\tabcolsep}\setlength\tabcolsep{3pt}
\begin{tabularx}{\linewidth}{@{}p{0.4\linewidth}p{0.59\linewidth}@{}}
    $W=\left[a, b\right]=\left(a, b\right)$ &

    \multirow{4}{*}{
        \includegraphics[width=0.99\linewidth, align=l]{Cont_Uniform_Distribution.png}
    }                                         \\
...
\begin{tabularx}{\linewidth}{@{}p{0.5\linewidth}p{0.49\linewidth}@{}}
    $W=\mathbb{R}$                                                                                                                       &
    \multirow{4}{*}{
        \includegraphics[width=0.99\linewidth, align=l]{Cont_Normal_Distribution.png}
    }                                                                                                                                      \\
...
\begin{tabularx}{\linewidth}{@{}p{0.5\linewidth}p{0.49\linewidth}@{}}
    $W=[0,\infty)$                                                                                   &
    \multirow{4}{*}{
        \includegraphics[width=0.99\linewidth, align=l]{Cont_Exponential_Distribution.png}
    }                                                                                                  \\
...
\begin{tabularx}{\linewidth}{@{}p{0.5\linewidth}p{0.49\linewidth}@{}}
    $W=[0,\infty)$                                                                                      &
    \multirow{4}{*}{
        \includegraphics[width=0.99\linewidth, align=l]{Cont_Gamma_Distribution.png}
    }                                                                                                     \\
...
\renewcommand{\arraystretch}{1.3}
\setlength{\oldtabcolsep}{\tabcolsep}\setlength\tabcolsep{3pt}
\begin{tabularx}{\linewidth}{@{}p{0.50\linewidth}p{0.49\linewidth}@{}}
    $W=[0,1]$                                                                                                          &
    \multirow{4}{*}{
        \includegraphics[width=0.99\linewidth, align=l]{Cont_Beta_Distribution.png}
    }                                                                                                                  \\
    $f(x)=\frac{\Gamma(\alpha)\Gamma(\beta)}{\Gamma(\alpha+\beta)}x^{\alpha-1}(1-x)^{\beta-1}\newline \text{where }\;0\leq x\leq1$ & \\
    $F(x)=\int_0^x f(u)du,\;x\geq0$                                                                                    & \\
