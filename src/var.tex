...
\newcommand{\summaryTitle}{Stochastics and Machine Learning}
\newcommand{\summarySubTitle}{FS24 ETHZ}
\newcommand{\summaryAuthor}{Juri Pfammatter, Daniel Schweizer and Tobias Meier}
\newcommand{\repoURL}{https://github.com/MeierTobias/eth-sto-ml}
...
\newcommand{\includeexamples}{0} % 0 = don't show examples, 1 = show examples